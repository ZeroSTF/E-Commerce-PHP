    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        ...
        <div class="page-title">
            ...
            <h3>Tables <small>Admin</small></h3>
            </div>
                ...
                <ul class="nav navbar-right panel_toolbox">
                  ...
                  <li class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item" href="triAdmin.php">Trier Par Nom</a>
        ...
        <h2>
            <a href="ajouterAdmin.php">Ajouter Admin</a>
        </h2>
    </center>
    ...
    <?php
              if(isset($_SESSION["login"])){
                ...
                if (isset($_GET['Nom_c']) && !empty($_GET['Nom_c'])) {
                  $admin = $clientC->RechercheClient($_GET['Nom_c']);
              } else {
                  $admin = $clientC->showAdmin();
              }
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="deleteAdmin.php?id_client=<?php echo $client['id_client']; ?>">Delete</a>
                </td>
            </tr>
        <?php
        }
