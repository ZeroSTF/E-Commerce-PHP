<?php
    ...
    )
	{
        if (
            ...
            $categorie1->modifiercategorie($categorie, $_POST["id_cat"]);
        ...
        <div class="">
          ...
          <div class="col-md-12 col-sm-12 ">
			...
			if (isset($_POST['id_cat'])){
				$categorie = $categorie1->recuperercategorie($_POST['id_cat']);
        ...
        <form action="" method="POST">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td><input type="text" name="description" id="description" value="<?php echo $categorie['description']; ?>" maxlength="20"></td>
                </tr>
