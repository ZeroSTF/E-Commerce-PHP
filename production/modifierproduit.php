<?php
    ...
    )
	{
        if (
            ...
            $produit1->modifierproduit($produit, $_POST["id_prod"]);
      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <div class="col-md-12 col-sm-12 ">
			...
			if (isset($_POST['id_prod'])){
				$produit = $produit1->recupererproduit($_POST['id_prod']);
        ...
        <form action="" method="POST">
            <table  class="table table-striped">
                <tr>
                    <td>
                        <label for="id_prod">id_prod:
                        </label>
                    </td>
                    <td><input type="id_prod" name="id_prod" id="id_prod" value="<?php echo $produit['id_prod']; ?>" maxlength="20"></td>
                </tr>
				<tr>
                    <td>
                        <label for="nom">Nom:
                    ...
                    <td><input type="nom_prod" name="nom_prod" id="nom_prod" value="<?php echo $produit['nom_prod']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                        <label for="prix">prix:
                    ...
                    <td><input type="prix" name="prix" id="prix" value="<?php echo $produit['prix']; ?>" maxlength="20"></td>
                </tr>
