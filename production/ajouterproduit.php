<?php
    include '..\production\model\produit.php';
    include '..\production\controller\produitC.php';
    include '..\production\model\categorie.php';
    include '..\production\controller\categorieC.php';
...
$listecategorie=$categorieC->affichercategorie();
    ...
    if (
        ...
        if (
            ...
            echo "hello im here";
            $produit1->ajouterproduit($produit,$_POST['id_cat'],$_POST["image"]);
...
<head>
  ...
  <script type="text/javascript" src="scriptte.js"></script>
    <style>
     .error{
      color: red;
     }
        ...
        <div class="">
          ...
          <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
              ...
              <form action="" name="produit" onsubmit="return validateForm(event)" method="POST">
        <div class="form">
            <div class="title"></div>
            <div class="subtitle">remplir le formulaire</div>
            <div class="input-container ic1">
              <input id="image"  name="image" class="input" type="file" placeholder="" />
              <div class="cut"></div>
              <label for="image" class="placeholder"> image</label>
            </div>
            <div class="input-container ic2">
              <input id="nom_prod" name="nom_prod" class="input" type="text" placeholder=" " />
              <div class="cut"></div>
              <label for="nom_prod" class="placeholder">nom produit</label>
              <p id="errorNC" class="error"></p>
            </div>
            <div class="input-container ic2">
              <input id="prix" name="prix" class="input" type="number" placeholder=" " />
              <div class="cut cut-short"></div>
              <label for="prix" class="placeholder"> prix </label>
            </div>
            <label for="id_cat">Choose a categorie:</label>
