<?php
	...
	include 'C:\xampp\htdocs\groupe1\achref\backend\mattys\production\controller\categorieC.php';
$categorieC=new categorieC();
$liste=null; 
$liste = $categorieC->affichercategorie1(); 
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="">
          ...
          <div class="col-md-12 col-sm-12  ">
            <div class="x_panel">
              ...
              <div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					...
					<a href="ajoutercategorie.php">Ajouter un categorie</a>
				</div>
			</div>
			...
			?>
                ...
                <td>              <img src="images/<?php echo $categorie['image']; ?>" alt="..." ></td>
								<td>
