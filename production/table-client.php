    ...
    <div class="main_container">
          ...
          <nav class="nav navbar-nav">
            <ul class=" navbar-right">
              <li class="nav-item dropdown open" style="padding-left: 15px;">
                ...
                <div class="dropdown-menu dropdown-usermenu pull-right" aria-Nom_cledby="navbarDropdown">
              ...
              <li role="presentation" class="nav-item dropdown open">
                ...
                <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-Nom_cledby="navbarDropdown1">
                  <li class="nav-item">
      ...
      <div class="right_col" role="main">
        ...
        <div class="page-title">
            ...
            <h3>Tables <small>Client</small></h3>
            </div>
            ...
            <div class="title_right">
              ...
              <div class="input-group">
                  ...
                  <input type="text" class="form-control"  name="Nom_c" id="Nom_c" placeholder="Recherchez">
          ...
          <div class="col-md-12 col-sm-12  ">
            <div class="x_panel">
              <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                  ...
                  <li class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-Nom_cledby="dropdownMenuButton">
                      <a class="dropdown-item" href="triClient.php">Trier Par Nom</a>
              ...
              if(isset($_SESSION["login"])){
                ...
                if (isset($_GET['Nom_c']) && !empty($_GET['Nom_c'])) {
                  $clients = $clientC->RechercheClient($_GET['Nom_c']);
              } else {
                  $clients = $clientC->showClients();
              }
          ...
          ?>
            ...
            <tr>
                ...
                <td>
                    <a href="deleteClient.php?id_client=<?php echo $client['id_client']; ?>">Delete</a>
                </td>
            </tr>
            <?php } ?>
