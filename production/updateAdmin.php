...
if (
    ...
    if (
        ...
        $clientC->updateClient($client, $_POST['email_c']);
...
<body class="nav-md">
  <div class="container body">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-table"></i> Tables <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a>Utilisateur<span class="fa fa-chevron-down"></span></a>
                    ...
                    <li><a href="table-categorie.php">Categorie</a></li>
                    <li><a href="table-gestion-table.html">Table</a></li>
                    <li><a href="table-promotion.html">promotion</a></li>
                    <li><a href="table-commande.html">commande</a></li>
                    <li><a href="table-forum.html">forum</a></li>
    ...
    if (isset($_SESSION["login"])) {
        $client = $clientC->showClient($_SESSION["login"]);
    ...
    ?>
        ...
        <form action="" method="POST">
                 ...
                 <tr>
                    ...
                    <td><input type="text" name="Nom_c" id="Nom_c" value="<?php echo $client['Nom_c']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="Prenom_c" id="Prenom_c" value="<?php echo $client['Prenom_c']; ?>" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="numero_c" value="<?php echo $client['numero_c']; ?>" id="numero_c">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="email_c"  id="email_c" readonly="readonly" value="<?php echo $client['email_c']; ?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="login" id="login" value="<?php echo $client['login']; ?>">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="mdp" id="mdp" value="<?php echo $client['mdp']; ?>">
                    </td>
                </tr>
                <tr>
                    <td></td>
